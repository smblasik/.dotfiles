...
-- Scrolling layout navigation (replaces the dwindle-only togglesplit)
hl.bind(mainMod .. " + J",           hl.dsp.layout("move -col"))        -- previous column
hl.bind(mainMod .. " + K",           hl.dsp.layout("move +col"))        -- next column
hl.bind(mainMod .. " + SHIFT + J",   hl.dsp.layout("expel"))            -- put window in its own column
hl.bind(mainMod .. " + SHIFT + K",   hl.dsp.layout("consume"))          -- merge window into previous column
hl.bind(mainMod .. " + H",           hl.dsp.layout("swapcol r"))        -- swap column right
hl.bind(mainMod .. " + G",           hl.dsp.layout("swapcol l"))        -- swap column left
hl.bind(mainMod .. " + ALT + Right", hl.dsp.layout("colresize +conf"))  -- widen column
hl.bind(mainMod .. " + ALT + Left",  hl.dsp.layout("colresize -conf"))  -- narrow column

-- Change focus (Super + Arrows cycle desktops)
hl.bind(mainMod .. " + Left",  hl.dsp.focus({ workspace = "m-1" }))  -- previous desktop
hl.bind(mainMod .. " + Right", hl.dsp.focus({ workspace = "m+1" }))  -- next desktop
hl.bind(mainMod .. " + Up",    hl.dsp.focus({ workspace = "m-1" }))  -- previous desktop
hl.bind(mainMod .. " + Down",  hl.dsp.focus({ workspace = "m+1" }))  -- next desktop
...
-- Switch focus between monitors (Ctrl + Super + Arrows)
